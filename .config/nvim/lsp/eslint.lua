...
return {
	...
	settings = {
		...
		experimental = {
			useFlatConfig = true, -- ESLint 9+ flat configs only
		},
		codeActionOnSave = {
			enable = false,
			mode = "all",
	...
	before_init = function(_, config)
		...
		-- Find the nearest ESLint Flat file config from the current file
		...
		-- This is crucial for monorepos where the config file might be in a subdirectory
